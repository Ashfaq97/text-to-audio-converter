...
IFontDisp = Font
__all__ = [ 'IFontDisp', 'FONTSIZE', 'FONTBOLD', 'OLE_YSIZE_PIXELS',
           'OLE_YSIZE_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL', 'OLE_COLOR',
           'Default', 'OLE_XPOS_PIXELS', 'VgaColor',
           'OLE_XPOS_HIMETRIC', 'FONTSTRIKETHROUGH', 'Gray',
           'OLE_XSIZE_HIMETRIC', 'OLE_XSIZE_CONTAINER', 'Checked',
           'IPictureDisp', 'FONTNAME', 'Monochrome', 'Font',
           'OLE_XPOS_CONTAINER', 'IPicture', 'OLE_TRISTATE',
           'OLE_YPOS_HIMETRIC', 'FONTITALIC', 'StdFont',
           'OLE_YPOS_CONTAINER', 'IFontEventsDisp', 'IFont',
           'OLE_CANCELBOOL', 'Unchecked', 'Color',
           'OLE_YSIZE_CONTAINER', 'FONTUNDERSCORE', 'FontEvents',
           'LoadPictureConstants', 'OLE_XSIZE_PIXELS', 'OLE_HANDLE',
           'Picture', 'OLE_YPOS_PIXELS', 'OLE_OPTEXCLUSIVE',
           'StdPicture']
